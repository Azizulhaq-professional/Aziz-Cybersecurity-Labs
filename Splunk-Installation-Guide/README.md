...
### 1. Ubuntu Setup
![Ubuntu Boot](Splunk/1UbuntuSplunk.png)  
![Virtual Machine Setup](Splunk/2VM.png)  
![System Name](Splunk/3Name.png)  
![System Specs](Splunk/4specs.png)  
![GRUB Loader](Splunk/5GRUB.png)

---

### 2. Profile & SSH
![Profile Creation](Splunk/6profile.png)  
![OpenSSH Installation](Splunk/7openssh.png)  
![No SSH Option](Splunk/8none.png)  
![System Reboot](Splunk/9reboot.png)

---

### 3. Updates & Network
![Update Packages](Splunk/11update.png)  
![Network Failure](Splunk/10failed.png)  
![Network Settings](Splunk/11zNetwork.png)  
![Static IP Config](Splunk/12staticip.png)  
![Static IP Config (Detailed)](Splunk/12.1staticip.png)  
![Netplan Configuration](Splunk/13netplan.png)
